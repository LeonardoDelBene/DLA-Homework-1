...
def res_mlp(train_loader, val_loader, test_loader,batch):
    ...
    for i in range(num_models):
        ...
        # Init modello, loss e ottimizzatore
...
if __name__ == "__main__":
    # Carica i dati MNIST dal file npz
    ...
    # Convertilo in tensori e applica la trasformazione individualmente
